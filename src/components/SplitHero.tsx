// Enhanced by AI on 2025-08-14T10:12:40.642Z
// Section: hero
// Category: hero
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-4 inline-flex w-fit items-center gap-2 rounded-full border border-primary/20 bg-primary/10 px-3 py-1.5 text-sm font-medium text-primary">
              ...
              New: AI-Enhanced Project Management
            </div>
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              ...
              <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                Projeqt - Project Management Made Easy
              </span>
            </h1>

            {/* Description */}
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Projeqt is a powerful project management platform that helps teams collaborate, track progress, and deliver projects on time. Unlock your team's full potential with our intuitive tools and AI-driven insights.
            </p>
